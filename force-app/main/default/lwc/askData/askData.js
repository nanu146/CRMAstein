...
export default class AskData extends LightningElement {
    ...
    renderedCallback() {
        console.log("renderedCallback(): main = ")
    ...
    handleResize() {
        ...
        console.log(this); // (!) not the binding we want -- this is now window, not the component...
        this.mainWidth = this.refs.main ? this.refs.main.offsetWidth : "not set";        
        this.mainHeight = this.refs.main ? this.refs.main.offsetHeight : "not set";        
        console.log(`mainWidth = ${this.mainWidth}, mainHeight = ${this.mainHeight}`);
    }
}